...
import TheHero from '@app/components/sections/TheHero'
import TheFeatures from '@app/components/sections/TheFeatures'
import TheQuotes from '@app/components/sections/TheQuotes'
